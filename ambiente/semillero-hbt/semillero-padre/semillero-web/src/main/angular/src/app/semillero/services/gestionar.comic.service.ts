...
export class GestionarComicService extends AbstractService {
   ...
   * @param idComic contiene el id del comic a eliminar
   */
  public eliminarComic(idComic : number): Observable<any> {
    return this.httpClient.post('http://localhost:8085/semillero-servicios/rest/GestionarComic/eliminar', idComic);
  }
